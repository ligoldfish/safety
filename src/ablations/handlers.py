...
_INPUTS = {
    ...
    "wjb_failure_analysis": ("common_test", "wildguard_model"),
    "global_default_budget": ("search_ledger",),
    "cross_corpus_matrix": ("checkpoint_registry", "common_test", "wildguard_model"),
    "target_control": (),
    "subspace_control": (),
    "bridge_control": (),
    ...
    "curation_control": (),
    "pan_subgroup_analysis": ("pan_predictions",),
    "general_capability_suite": ("trained_checkpoints", "benchmark_assets"),
    "representation_behavior_analysis": ("aligned_predictions",),
